...
resume: "Fournisseur de miel ARTISANAL retenu (Le Cueilleur de Miels, 17/08 — commande des 10 kg NON PASSÉE, volontairement : elle attend que la recette soit figée ; travail en cours sur le duo montagne+châtaignier, tilleul différé, doses non figées au 26/08 — Basekou annonce en avoir pour la semaine). Sourcing industriel : apprentissages (dont logique « 2 miels », sujet ouvert), shortlist tracks cristal/RTD, cartographie cristaux à lancer (le conditionneur pour Ramadan 2027 n'existe pas encore)."
---
...
| 9 | **Le Cueilleur de Miels** (`lecueilleurdemiels.fr`) | à compléter | Apiculteur — **> 300 ruches**, capacité **≥ 3 tonnes de miel/an**, prix **< 15 €/kg** (jugé « très intéressant ») | ✅ **FOURNISSEUR RETENU POUR LA PARTIE ARTISANALE (2026-08-17).** **Contact : Jérôme** (confirmé en session le 19/08). Appel passé, **dégustation faite**, échantillons de miels récupérés le **15/08**. **État au 2026-08-28 (confirmé en session)** : **les proportions ne sont toujours pas arrêtées** — la semaine annoncée le 26/08 se termine sans figeage. **Figeage PRÉVU le soir du 28/08** *(intention énoncée en séance, à confirmer)*. Structure précisée le 28/08 : **base verrouillée = montagne**, **miel de caractère à choisir — châtaignier OU tilleul** ; le tilleul n'est **plus simplement différé**, il est en concurrence directe et l'arbitrage fait partie du figeage. **📅 Objectif consigné : être opérationnel pour le 7/09.** *(Des séries de tests ont été menées depuis le 21/08 ; leurs résultats ne sont pas consignés ici — le dépouillement est en cours et rien n'entre en fiche avant qu'il soit terminé, par décision du 25/08.)* ⚠️ **10 kg PAS commandés, et c'est un choix, pas un retard** : la commande du 22/08 n'a pas été passée volontairement, parce que **commander avant d'avoir figé la recette, c'est commander pour un produit qui va changer**. **La commande se déclenche le jour où la recette est figée** — pas de date arrêtée avant cela. *(Historique : dégustation reportée le 04/08 — boutique fermée ; contact repris par messages le 11/08.)* |
