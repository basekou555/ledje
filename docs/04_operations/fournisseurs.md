...
| 9 | **Le Cueilleur de Miels** (`lecueilleurdemiels.fr`) | à compléter | Apiculteur — **> 300 ruches**, capacité **≥ 3 tonnes de miel/an**, prix **< 15 €/kg** (jugé « très intéressant ») | ✅ **FOURNISSEUR RETENU POUR LA PARTIE ARTISANALE (2026-08-17).** **Contact : Jérôme** (confirmé en session le 19/08). Appel passé, **dégustation faite**, échantillons de miels récupérés le **15/08**. **État au 2026-08-26 (confirmé en session)** : **les proportions ne sont toujours pas arrêtées**. Basekou annonce avoir **besoin de toute la semaine** pour les confirmer — c'est une durée dictée, pas une estimation de la session. Le chantier porte sur le **duo montagne + châtaignier** ; le **tilleul reste différé**, sa réintégration se décidera après. *(Des séries de tests ont été menées depuis le 21/08 ; leurs résultats ne sont pas consignés ici — le dépouillement est en cours et rien n'entre en fiche avant qu'il soit terminé, par décision du 25/08.)* ⚠️ **10 kg PAS commandés, et c'est un choix, pas un retard** : la commande du 22/08 n'a pas été passée volontairement, parce que **commander avant d'avoir figé la recette, c'est commander pour un produit qui va changer**. **La commande se déclenche le jour où la recette est figée** — pas de date arrêtée avant cela. *(Historique : dégustation reportée le 04/08 — boutique fermée ; contact repris par messages le 11/08.)* |
