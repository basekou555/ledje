...
- **[2026-09-08] ⚠️ UN MAIL A ÉTÉ ENVOYÉ À LA DDPP** *(déclaré en séance par Basekou)*. **Son contenu n'est pas connu de cette session** — le mail est parti de `basekou@ledje.fr` (Zoho), boîte non reliée aux outils de la routine, donc invérifiable. **Rien n'est écrit ici sur ce qu'il demande** : ni les 3 questions du 21/07, ni la DLC, ni autre chose — ce serait inventer. ⚠️ **Ce que ça déplace, en revanche, est certain** : la décision du 18/08 (« le mail n'est pas envoyé ») **n'est plus l'état courant**, et l'argument du 03/09 qui fondait le choix de la DLC — *« aucun mail de vérification à la DDPP n'étant prévu »* — **ne tient plus comme énoncé général**. Que cela touche ou non la DLC dépend de ce que le mail demande. **À préciser avant toute conséquence tirée** (`../02_produit/eau-miellee-33cl.md`, `production-artisanale.md`).
...
**⚠️ Réserve à lever : confirmer que le GBPH suffit pour une BOISSON au miel** (pas seulement du miel en pot).
À faire : récupérer + lire le GBPH apicole ITSAP ; construire le plan de maîtrise sanitaire documenté (traçabilité, températures, nettoyage) ; faire confirmer sa recevabilité par la DDPP compétente ; rapprochement ADA Bretagne / Chambre d'agriculture.
