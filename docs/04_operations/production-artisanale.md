...
✅ **ET LES DEUX PARAMÈTRES MANQUANTS SONT DONNÉS LE MÊME JOUR : APÉRO À 18h, 30 BOUTEILLES.** *(Basekou, 24/09.)* ➡️ **Les « ≈ 30 » cessent d'être une hypothèse : c'est le volume à produire, donc la base du chrono, de la dose de miel et de la facture.**
...
|---|---|---|---|
| 🏷️ **Tampon dateur** | Marquer **DLC + lot AAMMJJ** sur le bouchon | ✅ Commandé le 23/09 · 📦 **colis attendu le 24/09** | 🔴 **L'encre doit être déclarée apte au contact alimentaire** *(règl. 1935/2004)* — **à vérifier À LA RÉCEPTION** |
