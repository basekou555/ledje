...
⚠️ **Deux paramètres restent inconnus au 24/09, et ils ne sont pas cosmétiques** : **l'HEURE de l'apéro** *(elle décide de l'heure de production, donc du respect de la règle des 24 h)* et **le NOMBRE de personnes qui restent** — **les « ≈ 30 bouteilles » sont une hypothèse de Basekou, jamais un chiffre confirmé par Francesco.** ⛔ **Tant qu'ils ne sont pas connus, le volume à produire ne l'est pas non plus.**

*(Historique : cette section a porté « PRÉVU, pas acquis » du 23 au 24/09 — c'était juste, et ça a duré un jour.)*
...
📦 **LIVRAISON ANNONCÉE LE 24/09** *(« aujourd'hui j'attends le colis »)*. ⚠️ **Écrit tel qu'il a été dit, sans extrapoler : il a été question d'UN colis, et rien ne dit que les trois objets y sont.** ➡️ **À la réception, vérifier ce qu'il contient réellement avant de considérer le point comme couvert.**

🔴 **ET UN POINT QUI N'EST ÉCRIT NULLE PART : IL N'Y A AUCUN PLAN B SI LE TAMPON N'ARRIVE PAS.** L'événement du 29/09 est désormais **acquis sur le principe**, donc l'engagement est pris ; le marquage du bouchon, lui, reste une **obligation** *(art. 24 INCO)*. **Si le colis n'arrive pas — ou s'il n'y a pas le tampon dedans — le 29/09 pose un arbitrage à trancher, pas à contourner** : trouver un autre moyen de marquer, ou ne pas remettre les bouteilles. **Ce n'est pas encore décidé.**
