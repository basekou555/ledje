...
⚠️ **Statut : PRÉVU, pas acquis.** L'événement existe, la dégustation qui le suit est **à organiser avec Francesco** — le premier message part le 23/09. Tant qu'il n'a pas dit oui, rien ici n'est un fait.
...
|---|---|---|---|
| 🏷️ **Tampon dateur** | Marquer **DLC + lot AAMMJJ** sur le bouchon | ✅ **Commandé** — modèle non précisé en séance | 🔴 **L'encre doit être déclarée apte au contact alimentaire** *(règl. 1935/2004)* — **à vérifier À LA RÉCEPTION** |
| 💉 **Seringue de dosage** | Doser le miel **au volume** *(réf. 8,13 mL / 12,5 cL)* | ✅ **Commandée** — modèle non précisé en séance | ⚠️ **Aucun des 5 candidats du comparatif du 15/09 ne déclarait cette aptitude** — ce sont des dispositifs médicaux stériles. **Si celle-ci ne la déclare pas non plus, l'écart est connu et assumé, pas ignoré.** |
| 🌡️ **Thermomètre de frigo** | Lire la température que le PMS **exige** | ✅ **Commandé** — modèle non précisé en séance | — |
