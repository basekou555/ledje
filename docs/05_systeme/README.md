...
**Rôle** : ce qui fait fonctionner le cerveau lui-même — les règles de mise à jour, les
gabarits, l'historique des décisions, le backlog, les entrées de conseil. Aucun contenu
métier ici : que de l'outillage.
...
- `decisions-log.md` est **append-only**.
- Les templates évoluent librement à l'usage ; `workflow-maj.md` est protégé (modification
  sur demande explicite de Basekou).
