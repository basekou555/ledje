...
- ⚠️ **DÉNOMINATION LÉGALE — VÉRIFIÉE au fichier le 2026-08-27, elle était ABSENTE de la V1.6.** L'étiquette produite le 2026-07-24 portait **« Eau miellée — boisson à l'eau de source et au miel »**. Cette dénomination **n'était écrite dans aucune fiche jusqu'au 2026-08-26** — elle ne vivait que dans la page relais. Elle **tient** tant que l'eau de production est une eau de source (décision ci-dessus). ⚠️ **Vérifié au fichier le 2026-08-27** (PDF Drive « étiquette lédjé 185x67 V1.6 », 18/08) : **la V1.6 ne portait PAS cette dénomination** — elle affichait « lédjé / eau miellée » et « De l'eau et du miel. Rien de plus. », sans aucune dénomination descriptive. **Décision du 2026-08-27 : la réintégrer sur le fichier AVANT de l'envoyer à ETIQ'LYON**, au libellé complet **« Eau miellée — boisson à l'eau de source et au miel »** (« eau miellée » = nom de fantaisie ; « boisson à l'eau de source et au miel » = dénomination descriptive — les deux vont ensemble, la seconde ne peut pas disparaître). *(Correction **déclarée faite le 27/08**, dépôt Drive prévu le même jour — à confirmer au fichier.)* Une dénomination est une mention obligatoire (`reglementaire-etiquetage.md`), pas un choix de style : l'INCO prévoit un nom imposé par la loi, sinon le nom usuel, sinon un nom descriptif — rien n'établissant de nom imposé pour un mélange eau + miel, on est au troisième niveau.
