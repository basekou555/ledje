...
- **📏 Donner la proportion de l'étiquette, chiffrée** *(défaut relevé le 2026-09-11, plan J)*. Livré à lui-même, le modèle rend la bande à ≈ **la moitié** de la hauteur du flacon ; la vraie fait **50 mm sur 183 mm, soit ≈ un quart**. Formulation qui corrige : *« la bande d'étiquette fait environ un quart de la hauteur de la bouteille, dans sa moitié basse »*. ⚠️ **À ne pas confondre avec la déformation** (règle ci-dessus) : la déformation n'est pas corrigeable par le prompt, **la proportion l'est**.
