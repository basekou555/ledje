...
**⏳ Les 8 shots validés le 2026-09-11 ont une date de péremption, et elle est proche.** Ils reposent tous sur une **bouteille générée par IA**, admise par la **suspension transitoire du 09/09** — laquelle porte une **condition de sortie explicite : remplacée dès que le lot étiqueté existe**. Miel retiré le **13/09**, étiquettes imprimées : la condition est sur le point d'être remplie. ➡️ **Ce qui reste acquis après la sortie : la RECETTE** (décor, lumière, composition, geste). **Ce qui doit être refait : l'IMAGE.** ✅ **TRANCHÉ le 2026-09-11 — ces visuels sont EXPLOITABLES, sur le site ET sur les réseaux.** Basekou : *« pour moi ces visuels sont exploitables pour les réseaux et le site, mais si c'est temporaire. »* Le trou de règle sur **les réseaux** est comblé : ils entrent dans le même régime transitoire que le site. ⚠️ **« Temporaire » est la condition, pas une précaution de style** : ces images tiennent **jusqu'au lot étiqueté**, et sont remplacées à ce moment-là — publier avec ne prolonge pas l'autorisation.
...
`ID` · `Nom` · `⭐ Iconique ?` · `P (priorité)` · `Mission du shot` · `Sujet/Action (le delta narratif)` · `Recette (IDs de ledje-prompt-library.md : sujet, décor, caméra, lumière, matières, composition, action, émotion, + props)` · `Contraintes/Notes`. La Recette commence par le **SUJET** (SUJ, le héros physique — c'est lui qui pilote le bloc PRODUCT du prompt), puis décor, caméra, lumière, matières, composition, action, émotion, puis les props. Le champ **Prompt** de chaque fiche vit dans l'annexe "Prompts compilés" en fin de document (vide au départ, rempli au fil des validations). Tout ce qui est invariant reste dans `master-prompt.md`.
...
| ATT-04 | B03 | Portrait bouteille | | P2 | Le packshot produit | Bouteille de face, étiquette lisible (fond crème, wordmark vert) | SUJ-04 / DEC-00 / CAM-05 / LIGHT-03 / MAT-02 / COMP-03 / — / — | Packshot d'un vrai produit fini, crédible. Note d’usage : non vendue en ligne (contrainte logistique), mais bien réelle et en production. |
| ATT-05 | — | Reposée sèchement | ⭐ | P1 | Arrêter le scroll par le mouvement — **sans emprunter les codes de la pub soda** | La bouteille vient d'être reposée d'un coup : le liquide oscille encore à l'intérieur, quelques gouttes projetées du goulot, la main quitte le cadre | SUJ-04 / DEC-05 / CAM-01 / LIGHT-02 / MAT-03 / COMP-01 / ACT-01 / EMO-03 | ⭐ **MEILLEUR RÉSULTAT DU PREMIER LOT** (Basekou, 2026-09-11 : « les deux sont trop cool »). **Tranche le débat calme/agitation** : ce qui décide n'est pas l'intensité mais **l'origine du mouvement** — il vient de la boisson, jamais du décor. Le fond ne bouge pas. Formule exacte dans `ledje-asset-log.md`. |
| ATT-06 | — | Le packshot habité | | P1 | Le plan produit qui arrête l'œil — l'alternative au packshot de fiche produit | La bouteille ouverte, décentrée, le bouchon posé sur la pierre à côté, la condensation qui commence à couler | SUJ-04 / DEC-05 / CAM-01 / LIGHT-02 / MAT-01 / COMP-02 / ACT-01 / EMO-01 | ✅ Validé ×2 le 2026-09-11. **À ne pas confondre avec ATT-04**, qui reste le packshot de fidélité colorimétrique. ⛔ **Ne jamais utiliser `LIGHT-03` ici** : à sujet et cadrage identiques, elle a rendu ce plan « ennuyeux » — c'est `LIGHT-02` (rasante, ombre graphique de fenêtre) et le décentrage qui le sauvent, sans ajouter un seul élément. |
...
| EXP-04 | — | Le geste d'ouvrir | | P1 | La seconde d'avant — et l'échelle réelle du produit | Des doigts dévissent le bouchon noir, à mi-tour ; la bouteille est encore fermée, pleine, intacte | SUJ-04 / DEC-05 / CAM-01 / LIGHT-02 / MAT-01 / COMP-01 / ACT-04 / EMO-01 | ✅ Validé ×2 le 2026-09-11 (« les deux sont cool »). **Plan serré = bouteille et étiquette justes.** La main donne l'échelle que le packshot ne donne jamais. DA-02 : main et avant-bras seulement. |
| EXP-05 | — | La Recette | ⭐ | P1 | Répondre à « c'est quoi ? » sans un mot | Trois choses posées : la bouteille, un verre droit d'eau **claire**, et un cristal de miel sur la pierre | SUJ-04 / DEC-05 / CAM-01 / LIGHT-02 / MAT-01 / COMP-02 / ACT-01 / EMO-01 | ✅ Validé le 2026-09-11 (« très cool »). **Le meilleur énoncé visuel de « de l'eau et du miel, rien de plus »** : le verre d'eau **claire** posé à côté du liquide ambré donne une comparaison de couleur que rien d'autre ne donne. Cristal gardé générique (format non confirmé). Frère de PRV-07, qui dit la même chose sans la bouteille. |

## PROUVER

| ID | Ancien | Nom | ⭐ | P | Mission | Sujet / Action | Recette | Contraintes / Notes |
|---|---|---|---|---|---|---|---|---|
| PRV-01 | D01 | Le Lin | | P2 | La matière comme personnage | Verre posé sur lin froissé, une ombre traverse | SUJ-02 / DEC-00 / CAM-02 / LIGHT-01 / MAT-01 / COMP-01 / ACT-05 / EMO-02 | L'ombre = la trace de mouvement. |
| PRV-02 | D02 | La Pierre | | P2 | La minéralité, le socle | Goutte d'eau qui glisse sur du calcaire, verre en amorce | SUJ-02 / DEC-00 / CAM-02 / LIGHT-02 / MAT-01 / COMP-01 / ACT-01 / EMO-02 | |
...
| PRV-09 | EC05 | Macro étiquette | | P2 | Le soin du détail | Détail de l'étiquette : fond crème, grain du support, bord de l'étiquette, stries du rPET en arrière-plan | SUJ-05 / DEC-00 / CAM-02 / LIGHT-03 / MAT-02 / COMP-03 / — / — | ⚠️ **Typo NON tranchée** (l'ancienne spec « Fraunces or » est caduque) : ne jamais spécifier de police, ne pas rendre le texte lisible. Le shot porte la matière et le soin, pas le lettrage. |
| PRV-10 | — | La Matière | | P1 | Prouver que c'est une vraie photo — par le détail | Très gros plan sur le haut de la bouteille : condensation dense, une goutte qui coule, le liquide qui s'illumine par transparence | SUJ-04 / DEC-05 / CAM-02 / LIGHT-02 / MAT-01 / COMP-01 / — / EMO-01 | ✅ Validé ×2 le 2026-09-11 (« très cool »). **Deux variantes qui ne sont PAS deux versions, mais deux emplois** : ① **matière pure** (aucun texte) → pour une image **en série**, elle donne le contraste et le rythme ; ② **moins serrée**, qui laisse lire « De l'eau et du miel. Rien de plus. » → pour une image **seule** (hero, post isolé), car elle dit quelque chose en plus d'être belle. C'est le plan qui exploite le mieux la consigne « sur-décrire la condensation ». |

## PROJETER

| ID | Ancien | Nom | ⭐ | P | Mission | Sujet / Action | Recette | Contraintes / Notes |
|---|---|---|---|---|---|---|---|---|
| PRJ-01 | H02 | Le Premier Rituel | | P1 | Poser l'ambiance quotidienne | Une main s'approche du verre, lumière du matin | SUJ-02 / DEC-01 / CAM-01 / LIGHT-01 / MAT-01 / COMP-02 / ACT-01 / EMO-01 | |
| PRJ-02 | H04 | Le Quotidien | | P1 | Ancrer dans une vraie vie, pas un studio | Le verre posé dans un décor de vie habité | SUJ-02 / DEC-02 ou DEC-03 / CAM-04 / LIGHT-01 / MAT-01 / COMP-02 / ACT-01 / EMO-03 | Béton/ville discret en fond si DEC-03. |
...
| PRJ-07 | — | Le Partage | ⭐ | P1 | Montrer le partage — un thème de marque que la catégorie n'exploite pas | Une main tend la bouteille, une autre la reçoit ; les deux la tiennent en même temps, l'échange est à mi-chemin | SUJ-04 / DEC-05 / CAM-01 / LIGHT-02 / MAT-01 / COMP-01 / ACT-01 / EMO-03 | ✅ Validé le 2026-09-11. **Deux personnes sans un seul visage** : les avant-bras entrent par les côtés opposés, rien au-dessus des poignets (DA-02). C'est la réponse au besoin de présence humaine sans jamais montrer de regard. |
| PRJ-08 | — | La pièce habitée | | P2 | Se projeter — et servir la prospection (le restaurateur se situe) | La bouteille posée au coin d'une table dans une vraie pièce : chaise, linge, livre, porte de lumière. Elle appartient à la pièce, elle n'en est pas le sujet | SUJ-04 / DEC-05 / CAM-04 / LIGHT-02 / MAT-01 / COMP-02 / ACT-01 / EMO-03 | ✅ Validé le 2026-09-11 (« cool »). ⚠️ **Plan large = deux pièges.** ① L'**étiquette part hors proportion** (rendue à ≈ la moitié du flacon au lieu d'un quart) — **corrigeable au prompt**, préciser « la bande fait environ un tiers de la hauteur de la bouteille, dans sa moitié basse ». ② Risque de **déformation** du flacon — non corrigeable : générer la scène et **incruster le détourage**. |
...
| INV-08 | — | Le Service | ⭐ | P1 | Donner envie de s'en verser un — et montrer la boisson **hors de la bouteille** | Une main incline la bouteille au-dessus d'un verre droit ; le filet d'eau miellée est capté **en plein vol**, le verre est à moitié rempli. Le bouchon est posé sur la pierre. | SUJ-04 / DEC-05 / CAM-01 / LIGHT-02 / MAT-01 / COMP-01 / ACT-01 / EMO-01 | ✅ **PREMIER SHOT VALIDÉ À LA PRODUCTION** (Basekou, 2026-09-11 — « le visuel est cool »), cf. `ledje-asset-log.md`. **C'est le seul plan qui montre le liquide hors du flacon** : il prouve sa couleur et sa transparence au lieu de les affirmer, et confirme l'éclaircissement du liquide (se lit *eau miellée*, plus *thé glacé*). Main et avant-bras seulement, **rien au-dessus du poignet** (DA-02). ⚠️ **Préciser toujours « goulot nu, UN SEUL bouchon dans l'image »** — sans ça, ChatGPT en met deux. ⚠️ **Fournir la bouteille détourée en image de référence**, sinon le texte de l'étiquette est réinventé. |

## CONCLURE

| ID | Ancien | Nom | ⭐ | P | Mission | Sujet / Action | Recette | Contraintes / Notes |
|---|---|---|---|---|---|---|---|---|
| CON-01 | H05 | Le Calme | | P1 | L'émotion dominante, la dernière impression | Verre à moitié bu, personne dans le cadre, silhouette lointaine | SUJ-02 / DEC-04 / CAM-01 / LIGHT-02 / MAT-01 / COMP-02 / ACT-05 / EMO-02 | Le "après" — rarement montré par les marques de boisson. |
| CON-02 | Q05 | Le Retour | | P2 | La boucle qui se referme | Une silhouette entre dans le cadre, le verre attend sur la table | SUJ-02 / DEC-04 / CAM-01 / LIGHT-02 / MAT-01 / COMP-02 / ACT-05 / EMO-02 | Frère de CON-01, au moment inverse. Hérite de sa recette validée. |
